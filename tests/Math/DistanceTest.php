...
class DistanceTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testMinkowski()
    {
        ...
        $this
        ->assertEquals(pow(pow(3, 3) + pow(1, 3) + pow(4, 3) + pow(8, 3), (1
        / 3)), $d->data(array(0, 5, 6, 9), array(3, 4, 2, 1))->distance());
    }
    ...
    public function testManhattan()
    {
        ...
        $this
        ->assertEquals(3, $d->data(array(-2, 4), array(0, 5))->distance());
    }
    ...
    public function testHamming()
    {
        ...
        $this
        ->assertEquals(2, $d->data('1011101', '1001001')->distance());
    }
